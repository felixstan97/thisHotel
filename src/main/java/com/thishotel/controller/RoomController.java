...
/**
 * Admin endpoints to manage hotel rooms (CRUD + details).
 */
@RestController
@Validated
...
public class RoomController {
    ...
    public ResponseEntity<ApiResponseDTO<List<RoomResponseDTO>>> getAvailableRooms() {
        //todo aggiungere filtro -> con una query semplice (findAllByRoomStatus(RoomStatus.AVAILABLE)).
        return null;
    }
